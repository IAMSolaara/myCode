...
int NumeroD, NumeroB, bin1, bin2, bin3, bin4, bin5, bin6, bin7, bin8, Q, scelta, pot;
int main() {
//richiesta di un numero e error checking
	cout << "Scegliere un metodo di conversione\n";
	cout << "(0= divisione per 2; 1= divisione per potenze)\n";
	cin >> scelta;
