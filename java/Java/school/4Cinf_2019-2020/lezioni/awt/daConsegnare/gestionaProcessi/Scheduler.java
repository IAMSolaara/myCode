...
public class Scheduler {
	...
	public void addProcess(String name, int reqTime) {
		if (name != null) {
			ready.pushFromEnd(new Processo(name, reqTime, nextPid));
			nextPid++;
		}
	}
	...
	public Processo getExecProc () {
		return execProc != null ? new Processo (execProc) : null;
	}
